...
if("TRUE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/suramya/catkin_ws/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/suramya/catkin_ws/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/suramya/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'suramya <suramya@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/suramya/catkin_ws/src/robot_setup_tf/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robot_setup_tf_NUM_DUMMY_TARGETS)
      set(robot_setup_tf_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robot_setup_tf::wrapped-linker-option${robot_setup_tf_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robot_setup_tf_NUM_DUMMY_TARGETS "${robot_setup_tf_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robot_setup_tf::wrapped-linker-option${robot_setup_tf_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robot_setup_tf_LIBRARIES "${interface_target_name}")
